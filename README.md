...
- I am particularly leveraging my expertise in: Threat Intelligence, OSINT Investigations, APTs, Linux, Operational Security (OPSEC) and Digital Forensics. 
[![Typing SVG](https://readme-typing-svg.herokuapp.com?color=1FF773&width=750&lines=Cybersecurity,+Linux,+Coding,+Networking,+Virtualization,+Privacy+Freedom.)](https://git.io/typing-svg)
<!-- About Me -->

...
- I am particularly leveraging my expertise in: Threat Intelligence, OSINT Investigations, Linux, Operational Security (OPSEC) and Forensics. [![Typing SVG](https://readme-typing-svg.herokuapp.com?color=1FF773&width=750&lines=Linux,+Cybersecurity,+Coding,+Networking,+Money+Laundering+(jk).)](https://git.io/typing-svg)
<!-- About Me -->

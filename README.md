...
<!-- Skills -->
## Skills and Tech
[![My Skills](https://skillicons.dev/icons?i=linux,arch,kali,bash,git,github,githubactions,gitlab,docker,aws,md,nginx,prometheus,terraform,kubernetes,jenkins,ansible,emacs,neovim,linkedin&perline=13&theme=dark)](https://skillicons.dev)
<!-- Skills -->
